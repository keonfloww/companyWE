...
const LowPressureEquipmentForm: React.FC<FormInputProps> = props => {
      ...
      <View style={styles.headerContainer}>
        <View style={styles.viewForm}>
          <View style={styles.itemContainer}>
            <Text style={styles.itemText}>항목</Text>
          </View>
          <View style={styles.secondRowContainer}>
            <View style={styles.paddingLeft12}>
              <Text style={styles.itemText}>점검사항</Text>
            </View>
            <Text style={styles.checkListText}>점검결과</Text>
          </View>
        </View>
      </View>
      <View>
...
export default LowPressureEquipmentForm;
